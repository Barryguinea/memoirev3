...
représentatives pour l'inspection visuelle. Le script d'audit compare 248 valeurs empiriques
...
\begin{longtable}{p{0.43\textwidth}p{0.47\textwidth}}
  ...
  \path{manuscript_number_audit.csv} & Correspondance entre 248 valeurs du manuscrit et leurs artefacts sources. \\
