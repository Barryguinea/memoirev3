...
\path{data/validation/derived_metrics}. Le script d'audit compare ensuite 374 valeurs
...
\begin{longtable}{p{0.43\textwidth}p{0.47\textwidth}}
  ...
  \path{manuscript_number_audit.csv} & Correspondance entre 374 valeurs du manuscrit et leurs artefacts sources. \\
