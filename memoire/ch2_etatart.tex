...
Ce chapitre situe le travail dans la littérature existante. Il présente les approches
automatisées de détection, puis les deux méthodes non supervisées retenues comme
comparateurs. Il décrit ensuite la détection temporelle de changements persistants, dont le
système proposé s'inspire, et l'hétérogénéité des protocoles qui limite la comparaison des
performances publiées, avant d'énoncer le positionnement du mémoire.
...
chaque intervalle.
Les sommes cumulées proposées par E.~S. \citet{page1954continuous} constituent une famille
...
entre eux, ce que la section suivante met en doute.
