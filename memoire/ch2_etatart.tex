...
temporels décrits au Chapitre~\ref{chapitre:systeme}.
...
niveau de preuve: la branche HYPO est soumise à une évaluation attribuable, une ablation et
...
\begin{enumerate}
  ...
  référence, ablation contre IF et LOF, analyse OFAT de vingt variantes et stress test
  à dose appariée sur 198 événements;
...
Le Chapitre~\ref{chapitre:systeme} définit donc le système proposé et le protocole selon lequel
il est évalué, puis le Chapitre~\ref{chapitre:donnees} décrit les données utilisées, les
