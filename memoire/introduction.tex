...
\begin{enumerate}[itemsep=0pt, parsep=0pt, topsep=0.3\baselineskip]
  ...
  \item une extension bidirectionnelle qui sépare la surveillance de la notification et porte
  la couverture des scénarios de vérification de 61,4 à 72,7\,\%;
  \item des contrôles brefs et des facteurs confondants qui mesurent la spécificité au lieu de
  la supposer;
...
\end{enumerate}
Sur les dégradations graduelles injectées, HYPO recouvre 29 des 33 événements et en localise 13
au seuil IoU20, là où Isolation Forest et LOF n'en localisent aucun, et il produit dix-neuf fois
moins de notifications de fond qu'Isolation Forest ponctuel.
