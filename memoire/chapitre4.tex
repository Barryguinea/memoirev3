...
\begin{table}[H]
  ...
  11 contrôles brefs (négatifs), sur le critère de recouvrement attribuable.}
  \label{tab:hypo_ablation}
  \small
  \begin{tabular}{lrrrrr}
    \toprule
    Variante & Recouvrement & IoU20 & IoU moyen & Fond/vache-jour & F1 \\
    \midrule
...
et n'intègre pas la charge de fond: une détection plus permissive ferait même passer le
comparateur pédométrique devant HYPO sur ce seul résumé, au prix d'un fond bien plus élevé. Le
