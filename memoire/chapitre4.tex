...
supérieur à B et D ($p=0{,}04297$) et à C ($p=0{,}01562$). Ces comparaisons sur le recouvrement
restent toutefois secondaires et exploratoires~: après correction de la multiplicité (méthode
de Holm), l'avantage sur l'IoU demeure significatif, tandis que les écarts de recouvrement
proches de $0{,}04$ ne franchissent plus le seuil. L'avantage est aussi de
