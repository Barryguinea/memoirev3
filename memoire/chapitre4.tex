...
\begin{table}[H]
  \centering
  \caption[Ablation attribuable du module HYPO]{Ablation attribuable du module HYPO sur les
  mêmes événements. Le F1 événementiel oppose les 33 dégradations graduelles (positifs) aux
  11 contrôles brefs (négatifs), sur le critère de nouveau départ attribuable.}
...
exactement où on l'attend, en charge de fond~: chaque canal isolé notifie entre 0,49 et 0,52
fois par vache-jour, contre 0,40 pour HYPO. La posture seule illustre l'écueil inverse~: son
fond est le plus bas (0,393), mais elle ne localise presque rien (IoU20 de 2,3\,\%). Aucune
...
\begin{table}[H]
  \centering
  \caption[Ablation par famille de signaux]{Apport de chaque famille prise isolément, sur les
  mêmes 44 événements et la même attribution. Le détecteur temporel est restreint à un seul
  canal, la cohérence multi-familles étant relâchée. Le canal des pas reproduit la variante~E
  du Tableau~\ref{tab:hypo_ablation}.}
