...
Ce chapitre distingue deux niveaux de preuve. La première partie évalue le module HYPO sur
des dégradations graduelles, une ablation et une analyse OFAT complètes. La deuxième partie
...
La validation principale montre que HYPO localise mieux les dégradations graduelles que les
comparateurs IF et LOF, tout en conservant une charge de fond importante. Le comparateur
pédométrique obtient une localisation proche, mais recouvre moins d'événements et produit
une charge de fond plus élevée.
L'extension bidirectionnelle ajoute une information de surveillance et récupère les
séquences synthétiques, mais elle n'améliore pas IoU20, augmente le fond et reste vulnérable
aux causes non locomotrices. Elle constitue donc un résultat exploratoire mitigé et non une
preuve de supériorité ou de précurseur clinique.
