...
Pour généraliser ce constat au-delà des seuls pas, on rejoue la même ablation en restreignant
tour à tour le détecteur à chacune des quatre familles
(Tableau~\ref{tab:hypo_channels}). Chaque canal porte effectivement du signal, et certains,
