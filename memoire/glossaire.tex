...
\addcontentsline{toc}{chapter}{\texorpdfstring{\UpperRef{Liste des acronymes et abréviations}}{Liste des acronymes et abréviations}}

\begin{longtable}{@{}lp{11cm}@{}}
\textbf{AHDB} & \textit{Agriculture and Horticulture Development Board}: organisme britannique de développement agricole et horticole \\[3pt]
\textbf{AUC} & \textit{Area Under the Curve}: aire sous la courbe ROC utilisée dans ce mémoire comme mesure descriptive exploratoire \\[3pt]
...
\textbf{OFAT} & \textit{One Factor At a Time}: analyse de sensibilité faisant varier un seul paramètre à la fois \\[3pt]
\textbf{PLF} & \textit{Precision Livestock Farming}: élevage de précision \\[3pt]
\textbf{SHA-256} & \textit{Secure Hash Algorithm 256 bits}: fonction de hachage cryptographique utilisée pour vérifier l'intégrité des artefacts \\[3pt]
...
\addtocontents{toc}{\protect\vspace{1.5ex}}
\addcontentsline{toc}{chapter}{\texorpdfstring{\UpperRef{Termes techniques}}{Termes techniques}}
...
\textbf{IoU20} & Part des événements dont l'IoU atteint le seuil de 0,20 \\[3pt]
...
\textbf{Exécution propre} & Traitement de la série d'une vache sans injection, qui sert de comparaison pour n'attribuer que les alertes dues à l'événement injecté \\[3pt]
\textbf{IceQube} & Accéléromètre tri-axial d'IceRobotics fixé au métatarse de la patte arrière~; il produit, par intervalle de 15~minutes, les pas, l'indice de mouvement, les temps posturaux et les transitions \\[3pt]
...
\textbf{Notification de vérification} & Sortie de priorité 2 ou 3 demandant une observation ciblée de la vache, sans conclure à une boiterie \\[3pt]
