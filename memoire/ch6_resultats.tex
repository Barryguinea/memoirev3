...
\begin{table}[H]
  \centering
  \caption[Ablation attribuable du module HYPO.]{Ablation attribuable du module HYPO.
  La variante E localise les épisodes aussi précisément que le détecteur complet, mais elle
  ouvre moins de nouveaux départs et produit davantage de fond~; l'analyse de ce compromis
  suit le tableau.}
