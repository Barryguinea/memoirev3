...
\begin{figure}[H]
  ...
  \caption[Compromis détection-charge de fond]{Compromis détection-charge de fond.
    (a)~Réponse aux injections. (b)~Charge de fond.}
...
représentent les fenêtres injectées, les zones rouges les épisodes de vérification et les zones
ambrées les périodes de surveillance sans alerte; le rejet est ainsi la seule issue qui ne
reçoit aucun aplat. Les traits verticaux pointillés marquent les bornes exactes de la fenêtre
injectée, y compris lorsqu'elle ne dure qu'un seul pas de temps. Dans chaque panneau, les trois
...
courbe contre l'axe. Cette inspection vérifie la cohérence technique des sorties; elle ne
constitue pas une adjudication clinique.
...
\begin{landscape}
  ...
  \begin{figure}[H]
    ...
    \caption[Inspection visuelle de scénarios représentatifs]{Inspection visuelle de
      scénarios représentatifs. (a)~Hypoactivité modérée. (b)~Instabilité modérée.
      (c)~Pic capteur isolé. (d)~Hypoactivité non locomotrice.}
...
légèrement le détecteur complet, mais il ouvre moins de nouveaux départs (27,3 contre
43,2\,\%) et produit davantage de fond (0,518 contre 0,402). Les deux localisent en réalité de
...
\begin{figure}[H]
  ...
  \caption[Sensibilité locale des paramètres HYPO]{Sensibilité locale des paramètres
    HYPO. (a)~Réponse aux événements progressifs. (b)~Charge de fond.}
...
\begin{figure}[H]
  ...
  \caption[Comparaison des règles de fusion]{Comparaison des règles de fusion.
    (a)~Réponse par règle de fusion. (b)~Charge de fond.}
  \label{fig:fusions}
\end{figure}
