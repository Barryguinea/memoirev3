...
\begin{figure}[H]
  ...
  \caption{Compromis détection-charge de fond selon le seuil~: injections en (a), fond en (b).}
...
\begin{figure}[H]
  ...
  \caption{Comparaison des cinq règles de fusion~: réponse en (a), fond en (b).}
  \label{fig:fusions}
\end{figure}
