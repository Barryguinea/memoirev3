...
de HYPO. Dans la Figure~\ref{fig:fusions}, le panneau~(a) rapporte la réponse de chaque règle
et le panneau~(b) la charge de fond qu'elle produit, la ligne pointillée y repérant celle de
la fusion hiérarchique. La surveillance de l'instabilité y est identique pour les cinq règles,
puisqu'elle provient de la branche INSTABILITÉ seule et ne dépend pas de la règle appliquée.
