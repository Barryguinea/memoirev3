...
\begin{figure}[H]
  ...
  \caption{Compromis détection-charge de fond selon le seuil, avec les injections en (a) et le fond en (b).}
...
\begin{figure}[H]
  ...
  \caption{Comparaison des cinq règles de fusion, avec leur réponse en (a) et leur charge de fond en (b).}
  \label{fig:fusions}
\end{figure}
