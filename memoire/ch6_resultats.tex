...
\begin{figure}[H]
  ...
  \caption[Compromis détection-charge de fond]{Compromis détection-charge de fond.
    \mbox{(a)~Réponse aux injections.} \mbox{(b)~Charge de fond.}}
...
locomotrice produit une alerte comparable à celle d'une baisse locomotrice. La fenêtre injectée
...
intermédiaire et rend leur recouvrement directement lisible. Chaque panneau affiche douze
...
cette fenêtre relève donc du bruit de fond et n'entre pas dans les taux rapportés, ce qui
...
\begin{landscape}
  ...
  \begin{figure}[H]
    ...
    \caption[Inspection visuelle de scénarios représentatifs]{Inspection visuelle de
      scénarios représentatifs. \mbox{(a)~Hypoactivité modérée.}
      \mbox{(b)~Instabilité modérée.} \mbox{(c)~Pic capteur isolé.}
      \mbox{(d)~Hypoactivité non locomotrice.}}
...
\begin{figure}[H]
  ...
  \caption[Sensibilité locale des paramètres HYPO]{Sensibilité locale des paramètres
    HYPO. \mbox{(a)~Réponse aux événements progressifs.} \mbox{(b)~Charge de fond.}}
...
\begin{figure}[H]
  ...
  \caption[Comparaison des règles de fusion]{Comparaison des règles de fusion.
    \mbox{(a)~Réponse par règle de fusion.} \mbox{(b)~Charge de fond.}}
  \label{fig:fusions}
\end{figure}
