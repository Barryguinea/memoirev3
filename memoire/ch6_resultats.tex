...
\begin{figure}[H]
  ...
  \caption{Compromis détection-charge de fond selon le seuil, injections en (a) et fond en (b).}
...
\begin{figure}[H]
  ...
  \caption{Comparaison des cinq règles de fusion, réponse en (a) et charge de fond en (b).}
  \label{fig:fusions}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Notifications des sept jours précédant le score SLS, une vache par point.}
  \label{fig:sls}
\end{figure}
