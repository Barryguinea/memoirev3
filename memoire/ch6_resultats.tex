...
un IoU quasi nul. Sa faiblesse est ailleurs~: restreint aux pas, il ouvre moins de nouveaux
    ...
    0,402 notification par vache-jour). L'écart pédomètre moins HYPO atteint 0,116
    notification par vache-jour (IC95 [0,045~; 0,187]); huit vaches sur onze présentent moins de
    fond avec HYPO et le test exact apparié unilatéral vaut $p=0{,}01172$. Cette comparaison de
...
charge de fond sans changer la localisation. On examine ici si ce motif descriptif se retrouve
...
profil est compatible avec un gain de robustesse par cohérence, mais l'absence d'avantage
significatif sur le comparateur pédométrique empêche de l'établir comme effet causal indépendant.
...
l'IoU moyen n'est que de 0,038. Le stress test établit donc une robustesse temporelle positive
face aux cinq formes moins favorables et un avantage net sur IF et LOF, tout en révélant
précisément la limite à corriger~: avec les signaux disponibles, la spécificité de la cohérence
multivariée n'est pas démontrée et une vérification contextuelle reste nécessaire.
...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.05\textwidth}p{0.25\textwidth}p{0.42\textwidth}p{0.13\textwidth}}
    ...
    3 & Ablation et sensibilité HYPO
      & Supériorité sur IF/LOF; OFAT de vingt variantes; forte couverture des formes de stress
