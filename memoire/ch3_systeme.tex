...
peut devenir candidat. Ce découpage empêche une fuite directe de la période future vers la
référence, mais il suppose que les premiers 60\,\% décrivent suffisamment le fonctionnement
habituel de la vache; il ne garantit pas à lui seul l'absence d'un épisode atypique, d'une
dérive capteur ou d'un changement de conduite pendant cette période.
...
43,2\,\%~; avec deux heures, il descendrait à 38,6\,\%. La valeur retenue n'est donc pas celle
...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.31\textwidth}p{0.62\textwidth}}
    ...
    Stress test HYPO & Formes moins favorables à aire d'enveloppe appariée, sans nouveau réglage. \\
...
\begin{table}[H]
  ...
  \begin{tabular}{lll}
    ...
    openpyxl & 3.1.5 & Lecture du classeur SLS \\
...
La suite automatisée contient 114 tests et couvre le chargement, les variables dérivées,
...
fige ces sorties ainsi que l'empreinte du corpus confidentiel~; et un script dédié les
transforme en figures du manuscrit. Aucun résultat empirique n'est accepté sans comparaison
