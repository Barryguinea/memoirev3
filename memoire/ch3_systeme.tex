...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.31\textwidth}p{0.62\textwidth}}
    ...
    Stress test HYPO & Formes moins favorables à dose appariée, sans nouveau réglage. \\
...
La suite automatisée contient 107 tests et couvre le chargement, les variables dérivées,
les deux détecteurs, les cinq fusions, les injections, les contrôles après la période de référence,
l'appariement de dose, l'analyse de sensibilité, l'analyse SLS exacte et le démarrage de
