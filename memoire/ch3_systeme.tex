...
Le Tableau~\ref{tab:technologies} présente les principales dépendances figées dans le fichier
\path{requirements.txt}. Les versions exactes qui y figurent servent à reconstruire l'environnement et à
