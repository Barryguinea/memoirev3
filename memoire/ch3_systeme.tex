...
\begin{algorithm}[H]
\caption{Détection HYPO d'une baisse comportementale persistante, pour une vache}
\label{alg:hypo}
...
\PourChaque{intervalle $t$ de la période surveillée}{
  ...
  \tcp*{posture : excès de temps couché et déficit de temps debout}
  ...
  impliqués, et couverture suffisante}{
    ...
    \tcp*{l'intervalle devient candidat}
  }
  \Sinon{
    $e_t \leftarrow 0$\;
  }
...
\SinonSi{$\mathrm{instab}$}{
  ...
  \tcp*{à surveiller, sans vérification prioritaire}
}
\BlankLine
\Si{priorité $\geq 2$}{
