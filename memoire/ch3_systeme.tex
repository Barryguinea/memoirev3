...
Section~\ref{sec:sensibilite} en documente la robustesse locale.
...
La suite automatisée contient 118 tests et couvre le chargement, les variables dérivées,
...
script dédié les transforme automatiquement en figures du manuscrit. Aucun résultat empirique n'est accepté sans comparaison
