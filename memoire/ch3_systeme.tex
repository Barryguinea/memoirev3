...
somme cumulée unilatérale de E.~S. \citet{page1954continuous}. Il est défini par
...
\citep{sklearn_api}, sur l'intervalle inter-quantile 10--90, qui résiste aux distributions fortement asymétriques des signaux d'activité. Le
...
la trace de référence de l'expérience. La Figure~\ref{fig:repro_chain} illustre cette chaîne de reproductibilité.
