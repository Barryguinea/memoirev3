...
% Police du texte et des mathematiques, famille unique a empattement.
% Le guide de mise en page de l'UQAM ne prescrit aucune police : il cite Times
% New Roman ou Calibri en exemples, a une taille comparable a Calibri 11 pt, et
% demande l'uniformite dans tout le document. newtx compose le texte ET les
% formules dans la meme famille, ce que la variante precedente ne faisait pas :
% le corps etait en Carlito sans empattement, les formules en Computer Modern.
\usepackage{newtxtext}
\usepackage{newtxmath}
%
% RETOUR A LA VARIANTE PRECEDENTE (Carlito, clone libre de Calibri) : commenter
% les deux lignes ci-dessus et decommenter la suivante. Le memoire repasse alors
% a 128 pages, avec le melange de familles decrit plus haut.
...
\include{ch3_systeme}
\include{ch4_donnees}
\include{ch5_interface}
\include{ch6_resultats}
