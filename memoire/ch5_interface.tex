...
\begin{landscape}
  ...
  \begin{figure}[H]
    \centering
    % 0,95 : largeur maximale utile sur la page paysage. La capture faisant
    % 2236 px, cette largeur la ramene a 261 ppp, sous le seuil d'impression de
    % 300 ; une capture de 2716 px tiendrait ce seuil a la meme largeur.
    \includegraphics[width=0.95\linewidth]{figures/streamlit_priority_animals.png}
