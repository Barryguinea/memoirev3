...
à maintenir de façon régulière sur l'ensemble d'un troupeau. Les branches de détection
...
\begin{figure}[H]
  \centering
  % La capture fait 2878 px de large : a 0,98 de la largeur du texte elle rend
  % a 489 ppp, tres au-dessus du seuil d'impression. Le rapport large et bas
  % de la vue tient en une demi-page en portrait.
