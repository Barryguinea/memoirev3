...
\begin{landscape}
  ...
  \begin{figure}[H]
    \centering
    % 0,96 et non 0,98 : la capture fait 2370 px pour un rapport de 1,53, si bien
    % qu'a 0,98 la figure et sa legende depassaient de trois dixiemes de point la
    % hauteur disponible. Ce depassement suffisait a repousser le flottant et a
    % ajouter une page. A 0,96 elle occupe 5,65 pouces sur 8,67 de large et rend
    % a 273 ppp, sous le seuil usuel mais sans perte visible sur un trace au
    % trait. La largeur reste prise au plus haut : les graduations et les dates
    % des vignettes ne se lisent qu'a cette taille.
