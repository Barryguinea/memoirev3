...
\begin{landscape}
  ...
  \begin{figure}[H]
    \centering
    % 0,95 : la capture faisant 2844 px, cette largeur laisse encore 331 ppp,
    % au-dessus du seuil d'impression. Le passage en paysage ne coute donc rien
    % en finesse et gagne un tiers de largeur.
    \includegraphics[width=0.95\linewidth]{figures/streamlit_individual.png}
...
% Page paysage. Neuf vignettes reparties sur trois rangees restent illisibles a
% la largeur du texte : la vue pivotee leur donne un quart de largeur en plus,
% et c'est la lisibilite qui prime ici sur la finesse d'impression. Meme
...
\begin{landscape}
  ...
  \begin{figure}[H]
    \centering
    % 0,90 et non davantage : la capture des neuf vignettes a un rapport de
    % 1,40, si bien qu'a 0,95 la figure et sa legende totalisent 6,54 pouces
    % pour 6,53 disponibles. Ce depassement d'un centieme suffisait a repousser
    % le flottant et a laisser une page blanche derriere lui.
    \includegraphics[width=0.90\linewidth]{figures/streamlit_priority_animals.png}
