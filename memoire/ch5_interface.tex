...
% Retour au portrait. La page paysage se justifiait quand la capture ne
% montrait que six vignettes sur deux rangees : tres large et peu haute, elle
% avait besoin de la largeur pivotee. Sur trois rangees, son rapport tombe a
% 1,40 et le portrait lui suffit. Surtout, l'image ne fait que 1952 px : la
% poser sur toute la largeur paysage la ramenait a 240 ppp, sous le seuil
% d'impression, alors qu'a la largeur du texte elle en donne 305 pour une
% taille pratiquement identique. Le portrait supprime en outre la page dediee
% et son blanc, et replace la figure a la suite immediate de son paragraphe.
\begin{figure}[H]
  \centering
