...
Ce chapitre décrit l'interface de priorisation. Il présente le besoin opérationnel et les
principes de conception qui en découlent, puis le tableau de bord et ses trois échelles de
lecture. Il détaille ensuite les niveaux de priorité et l'action associée, l'export et la
traçabilité des alertes, avant d'exposer la portée et les limites de cet usage.
...
que ce tri représente et ses conséquences pratiques pour l'éleveur sont examinées dans la
discussion générale.
