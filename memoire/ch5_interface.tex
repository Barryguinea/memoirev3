...
\begin{landscape}
  ...
  \begin{figure}[H]
    \centering
    % 0,90 : la figure occupait le seul tiers superieur de la page paysage. La
    % capture faisant 2236 px, cette largeur la ramene a 275 ppp, sous le seuil
    % d'impression de 300 ; une capture de 2573 px permettrait 0,95 en le tenant.
