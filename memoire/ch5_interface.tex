...
individuel. La courbe placée sous la carte donne directement cette proportion, jour après jour.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.98\textwidth]{figures/streamlit_heatmap_compact.png}
  \caption{Alertes journalières par vache et proportion du troupeau en alerte.}
