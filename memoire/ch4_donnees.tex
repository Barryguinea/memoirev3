...
le \textit{Motion Index}; au grain brut de quinze minutes, le temps d'autocorrélation intégré
est de l'ordre d'une heure pour les signaux d'activité. Au niveau de décision, les totaux
glissants de douze heures portent ce temps à environ huit heures~: la médiane par vache tombe
...
et douze une série longue. Une vache est admissible à l'évaluation synthétique si sa durée
...
officiel pour ces vaches. Cette vérification porte sur cinq des vingt-huit vaches~; le
...
% =====================================================================
Le cadre expérimental comprend trois campagnes injectées sur le corpus principal, puis une
cohorte observationnelle distincte.

L'étude comporte trois niveaux principaux et une extension de stress. Le premier évalue HYPO sur 44 événements et le compare aux
trois variantes fondées sur IF ou LOF ainsi qu'au comparateur pédométrique. Le deuxième étend
la campagne à 132 scénarios pour explorer INSTABILITÉ et cinq règles de fusion. À chaque
niveau, un scénario est injecté dans une copie distincte de la période future, puis comparé à
l'exécution propre de la même vache. Le troisième niveau est une analyse observationnelle sur
une cohorte IceTag-SLS de l'hiver 2019. Il utilise des mesures strictement antérieures au score
locomoteur et ne sert pas à régler le système. La Figure~\ref{fig:plan_etude} schématise ces
trois niveaux. Ce plan forme un banc d'essai contrefactuel reproductible: l'événement
synthétique est le seul changement volontaire entre l'exécution propre et l'exécution
injectée, ce qui permet de mesurer la réponse du détecteur sans modifier la période de
référence ni optimiser les seuils sur les sorties observées.
...
apparie la dose de perturbation: pour chaque famille modifiée, l'aire discrète sous
...
un effet qui proviendrait seulement d'une perturbation plus forte. Le contrôle négatif
modifie uniquement les pas avec la même dose; le scénario de données manquantes retire un
bloc contigu de douze heures après cet appariement.
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[
    ...
    \node[box, fill=loforange!10, right=0.4cm of split] (inject) {HYPO: 44\\stress: 198\\extension: 132};
...
trois heures et ne devrait pas former un épisode persistant. Cette campagne reprend le cadre
contrefactuel de la Section~\ref{sec:cadre_experimental}; pour HYPO, l'exécution propre de la
même vache est soustraite lors du calcul des métriques attribuables.
