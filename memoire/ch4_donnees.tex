...
le \textit{Motion Index}. Au niveau de décision, les totaux glissants de douze heures portent
le temps d'autocorrélation intégré à environ huit heures~: chaque vache n'apporte alors
qu'environ 17 points de décision indépendants. Ce résultat justifie l'agrégation statistique
par vache et le rééchantillonnage groupé employés dans l'évaluation.
