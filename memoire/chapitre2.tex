...
\(C_t\geq1{,}20\). Deux notifications HYPO sont espacées d'au moins 24 heures. La
Figure~\ref{fig:hypo_cusum_example} illustre ce mécanisme sur une vache, en comparant
