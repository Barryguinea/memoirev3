...
La Figure~\ref{fig:hypo_cusum_example} illustre ce mécanisme sur une vache et une
dégradation graduelle injectée après la période de référence. Le panneau supérieur montre que
