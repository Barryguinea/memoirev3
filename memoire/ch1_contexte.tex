...
\begin{table}[H]
    ...
    \begin{tabular}{lcc}
        ...
        Ferme type de 65 vaches & 4\,933~\$~US / an & \cite{bruijnis2010assessing} \\
        \bottomrule
    \end{tabular}

    \vspace{0.4em}
    {\footnotesize\raggedright Les quatre montants tirés de \citet{bruijnis2010assessing}
    sont convertis des euros publiés par cette source, au taux de 1,42~\$~US pour 1~euro.\par}
\end{table}
