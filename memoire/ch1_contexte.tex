...
\begin{table}[H]
    ...
    \begin{tabular}{lcc}
        ...
        \midrule
        Perte de production laitière & $\approx$360 kg/lactation (305 j) & \citep{green2002financial} \\
        Trouble du pied clinique & 95~\$~US / cas & \citep{bruijnis2010assessing} \\
        Trouble du pied subclinique & 18~\$~US / cas & \citep{bruijnis2010assessing} \\
        Coût par vache et par an & 75~\$~US & \citep{bruijnis2010assessing} \\
        Ferme type de 65 vaches & 4\,933~\$~US / an & \citep{bruijnis2010assessing} \\
        \bottomrule
    \end{tabular}

    \vspace{0.4em}
    {\footnotesize\raggedright Les quatre montants du tableau sont convertis des euros publiés par la source
    \citep{bruijnis2010assessing}, au taux de 1,42~\$~US pour 1~euro.\par}
\end{table}
...
75~\$~US par vache et par an et près de 4\,933~\$~US par an pour une
...
l'action associée à chaque score, d'après la grille locomotrice \citep{sprecher1997lameness} et
...
\begin{table}[H]
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}p{2.8cm}
        ...
        & \citep{alsaaod2012electronic,balasso2023behaviour} \\
        \addlinespace
        Podomètre
        & Nombre de pas, distance parcourue
        & Simple, robuste
        & Signal limité, faible résolution
        & \citep{flower2006effect,mazrier2006reliability} \\
        \addlinespace
        ...
        & \citep{lavrova2023lameness,vanhertem2013lameness} \\
        \bottomrule
    \end{tabular}
\end{table}
