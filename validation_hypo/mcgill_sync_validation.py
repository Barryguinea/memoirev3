...
def _find_mcgill_root() -> Path:
    candidates = [
        ROOT.parent / "PROJECT" / "mcgill_iot_cattle",
        ROOT.parent / "mcgill_iot_cattle",
        ROOT / "mcgill_iot_cattle",
    ]
...
OUT = ROOT / "data/validation/mcgill"
