...
from revalidation.qa import assert_campaign_valid, write_json, write_sha256_manifest


PROJECT_ROOT = Path(__file__).resolve().parents[1]
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "data" / "revalidation" / "parameter_sensitivity"
MODULE_VERSION = 1
