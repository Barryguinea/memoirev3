...
| Benchmark | `validation_hypo/campaign.py` |
| Ablation | `validation_hypo/ablation.py` |
| Revue manuelle | `validation_hypo/manual_review.py` |
| Analyse SLS | `validation_hypo/mcgill_sync_validation.py` |
| Provenance | `validation_hypo/finalize_artifacts.py` |
| Interface | `app.py`, `ui/` |
