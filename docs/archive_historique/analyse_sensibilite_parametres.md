...
Le module `validation_hypo.sensitivity` mesure la variation des resultats lorsque
...
python -m validation_hypo.sensitivity --list-configurations
```
...
`data/validation/parameter_sensitivity/runs/`. Une relance reprend les runs
