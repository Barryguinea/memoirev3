...
| `validation_hypo/` | benchmark post-baseline, ablation, SLS et provenance |
| `notebooks/validation_complete.ipynb` | orchestration reproductible de la campagne |
| `tests/` | contrats, invariants, UI et protocole |
| `data/brut.csv` | corpus IceQube de référence |
| `data/validation/` | résultats et manifestes actuels |
...
| Fichier | Rôle |
|---|---|
| `validation_hypo/injection.py` | profils graduels et contrôle bref |
| `validation_hypo/campaign.py` | exécutions propre/injectée et métriques attribuables |
| `validation_hypo/analysis.py` | synthèses et statistiques |
| `validation_hypo/ablation.py` | comparaison des quatre méthodes |
| `validation_hypo/manual_review.py` | échantillon visuel et annotations |
| `validation_hypo/mcgill_sync_validation.py` | confrontation Winter 2019 avec SLS |
| `validation_hypo/finalize_artifacts.py` | instantané et manifeste SHA-256 |
