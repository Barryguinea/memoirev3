# Résultats corrigés du prototype MemoireV3
...
prête à remplacer MemoireV2 comme résultat principal. Une validation clinique
...
- `data/revalidation/v3_refined_full/comparison_summary.csv`;
- `data/revalidation/v3_refined_full/events_*.csv`;
- `data/revalidation/v3_mcgill_sls/mcgill_v3_cohort_all_variants.csv`;
- `data/revalidation/v3_mcgill_sls/mcgill_v3_metrics.csv`;
- `data/revalidation/v3_mcgill_sls/mcgill_v3_summary.json`;
- `logs/v3_refined_full_2026-06-12.log`.
