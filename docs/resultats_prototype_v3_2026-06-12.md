# Résultats initiaux du prototype MemoireV3
...
> `resultats_v3_corriges_2026-06-12.md`.
...
2. L'ajout de la branche INSTABILITE ne produit pas actuellement une meilleure
   performance globale que le détecteur HYPO de MemoireV2.
...
- `data/revalidation/v3_sensitivity_full/sensitivity_summary.csv`;
- `data/revalidation/v3_sensitivity_full/events_*.csv`;
- `logs/v3_sensitivity_full_2026-06-12.log`.

## Décision recommandée

Conserver MemoireV3 comme branche expérimentale. La prochaine amélioration doit
...
Sans progrès mesurable, MemoireV2 reste scientifiquement plus défendable.
