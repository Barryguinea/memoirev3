# Résultats figés de la revalidation du 12 juin 2026
...
- configuration du détecteur fixée avant l'évaluation et enregistrée dans
  `data/revalidation/protocol_configuration.json`;
...
`data/revalidation/manual_review_annotations.csv` et
`data/revalidation/manual_review_sample.csv`.
...
- notebook exécuté: `notebooks/revalidation_complete_executed_2026-06-12.ipynb`;
- instantané: `data/revalidation/snapshot_2026-06-12.json`;
- configuration: `data/revalidation/protocol_configuration.json`;
- manifeste: `data/revalidation/revalidation.sha256`.
