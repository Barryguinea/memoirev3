"""Comparaison des fusions et sensibilité du prototype bidirectionnel final.
...
from validation_hybrid.campaign import run_campaign
...
def run_sensitivity(
    *,
    smoke: bool = False,
    output_dir: str = "data/validation/hybrid_refined",
) -> pd.DataFrame:
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="data/validation/hybrid_refined")
