...
\usepackage[utf8]{inputenc} % Encodage UTF-8 standard
\usepackage[T1]{fontenc}
\usepackage{silence}
\usepackage{url}
% \usepackage[a-1b]{pdfx} % à réactiver uniquement pour une finalisation PDF/A
...
% Pour la page titre
%%%%%%%%%%%%%%%%%%%%
\title{Détection de boiterie bovine probable à partir de données capteurs}
